...
const styles = StyleSheet.create({
  ...
  activeType: { backgroundColor: "#E4F2EE", borderColor: "#20786B" },
  typeText: { color: "#78908B", fontSize: 12 },
  activeTypeText: { color: "#20786B", fontWeight: "800" },
  upload: {
    backgroundColor: "#FFF",
    borderWidth: 1,
    borderColor: "#DCE9E5",
  ...
  uploadTitle: { color: "#183B36", fontWeight: "800" },
  uploadSub: { color: "#A2B3AF", fontSize: 12, marginTop: 4 },
  button: {
